...
namespace ImGui
{
    namespace linc
    {
        ...
        // Input Widgets
        extern bool InputText(const char* _label, Array<char> &_buffer, ImGuiInputTextFlags _flags = 0, ImGuiTextEditCallback _callback = NULL, void* _userData = NULL);
        extern bool InputTextMultiline(const char* _label, Array<char> &_buffer, const ImVec2& _size = ImVec2(0, 0), ImGuiInputTextFlags _flags = 0, ImGuiTextEditCallback _callback = NULL, void* _userData = NULL);
